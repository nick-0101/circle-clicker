...
pygame.init()
pygame.display.set_caption('Circle Clicker - Game Won')
...
def game_won(player_level, player_highscore, player_timeInGame):
    # Resolves circular import
    from game_screen import game

    while True:
        screen.fill(GAME_BACKGROUND_CLR)
        draw_text('Game Won:', font, (255, 255, 255), screen, 10, 150)
